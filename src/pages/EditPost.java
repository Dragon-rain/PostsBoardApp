...
public class EditPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String head = "<head><title>Edite post</title><link rel='stylesheet' type='text/css' href='" + cssLocation + "'></head>";
	    out.println("<html/>");
	    out.println(head);
	    out.print(Header.GetHeader());
	    out.print("<form method='post'>");
	    out.print("<label>Title:</label></br>");
		out.println("<input name='title' value='"+post.getTitle()+"' required='required'/></br>");
		out.print("<label>Description:</label></br>");
		out.println("<textarea name='description' required='required'>"+post.getDescription()+"</textarea></br>");
		out.print("<button>save</button>");
		out.print("</form>");
		out.print("</body></html>");*/
	}
